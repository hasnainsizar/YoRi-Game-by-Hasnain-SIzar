...
* **Student Grading Rubric (75pt)**
  * **User Experience Design (20 points total)**
    * The dice and game pieces can be distinguished with ease, and the game board is visually pleasing. (7.5pt)
    * The user interface is simple, and the player may quickly grasp the goals and regulations of the game. (7.5pt)
    * The game includes appropriate sound effects and background music that enhances the overall experience. (5pt)
  * **Game Mechanics (20 points total)**
    * The following areas adhere to the modified Ludo rules and mechanics.
      * Player turns (5pt)
      * Dice roll (5pt)
      * Piece movement  (10pt)
  * **Testing and Debugging (5 points total)**
    * Significant errors or bugs are not present in the program. (5pt)
  * **GAME LAYOUT (20 points total)**
    * The winner is displayed on the screen when the first player gets both of the pieces to the home area. (5pt)
    * A main menu screen is implemented to add the following options: (5pt)
      * Start the game: Pressing 1, start the game.
      * Show instructions on how to play the game: Press 2 and the game instructions are shown. Press ESC to go         back.
      * Quit: Press 3, the game quits. 
    * Upon collision, The collided piece should be sent back to its base. (5pt)
    * A piece that has just got out of the base area cannot collide with a piece of different color straight away at the start spot. (5pt)
  * **Documentation of the project (10 points total)**
    * The student presents the appropriate documentation needed to start the game with all the rules and mechanics. (10pt)
